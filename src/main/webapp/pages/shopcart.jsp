...
<script type="text/javascript"
	src="<%=root%>/scripts/jquery-1.4.2.min.js"></script>
...
<body>
	<div class="hd_global_top_bar">
		<div class="mainbox">
			<span class="top_bar_wrap">客服热线：0571-56839396</span> <span
				class="top_bar_wrap ">购物车(2)</span> <span
				class="top_bar_wrap  icon-up"> 用户中心
				<ul class="top_bar_dropmenu" style="display:none">
					<li>商品收藏</li>
					<li>商品收藏</li>
					<li>商品收藏</li>
					<li>商品收藏</li>
				</ul>
			</span> <span class="top_bar_wrap">首页</span> <span class="top_bar_wrap"
				style="border-left:0"> magister.feng 您好，欢迎来到克莱姆！</span>
		</div>
	</div>
	...
	<div class="mainbox usermain clearfix">
		<div class="user-right">
			...
			<div class="total">
				<a href="cdd" class="btn3">去结算</a> <span>合计（不含运费）：<font color="red">¥</font><font id="zje" color="red">0</font></span>
			</div>
		</div>
		<div class="user-left">
			<h1>帐户中心</h1>
			<ul>
				<li><a href="#">个人主页</a></li>
				<li><a href="#" class="current">我的购物车</a></li>
				<li><a href="#">我的订单</a></li>
				<li><a href="#">汇款方式</a></li>
			</ul>
		</div>
	...
	<div class="linkme mainbox">
		<div>
			<span>关于我们</span>| <span>联系我们</span>| <span>人才招聘</span>| <span>商家入驻</span>|
			<span>营销中心</span>| <span>手机京东</span>| <span>友情链接</span>| <span>销售联盟</span>|
			<span>京东社区</span>| <span>京东公益</span>
		</div>
		<div>
			...
			网络文化经营许可证京网文[2011]0168-061号 违法和不良信息举报电话：4006561155 Copyright ©
			2004-2014 京东JD.com 版权所有<br> 京东旗下网站：360TOP 拍拍网 网银在线<br>
		</div>
	</div>
