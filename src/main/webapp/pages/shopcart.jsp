...
<body>
    <div class="hd_global_top_bar">
        <div class="mainbox">
            ...
            <span class="top_bar_wrap ">购物车(2)</span>
            <span class="top_bar_wrap  icon-up">
                用户中心
        ...
        <div class="user-right">
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                ...
                <td ><input type="checkbox" name="name" value=" " /></td>
                    <td > <a href="#" class="link">${item.spJg}</a> </td>
                    <td class="alir">${item.spJg}</td>
                    <td>${item.spSl}</td>
                    <td class="alir">${item.spZj}</td>
                    <td> <a href="cdd" class="btn2">删除</a> </td>
                </tr>
                </c:forEach>
            </table>
            <div class="total">    <a href="cdd" class="btn3">合计</a>  <span>合计（不含运费）：580</span> </div>
        </div>
        <div class="user-left">
            <h1>帐户中心</h1>
            <ul>
